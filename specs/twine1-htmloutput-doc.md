...
```html
<div tiddler="StoryTitle">Title</div>
<div tiddler="StoryAuthor">Author</div>
<div tiddler="StorySubtitle">Subtitle</div>
<div tiddler="StorySettings">
  jquery:off\nhash:off\nbookmark:on\nmodernizr:off\nundo:off\nobfuscate:rot13\nexitprompt:off\nblankcss:off\n
</div>
```
...
```html
<div tiddler="Start" tags="" created="202306020121" modifier="twee" twine-position="10,10">[[One passage]]</div>
```
